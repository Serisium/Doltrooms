...
| JS/WASM | `npm install @dolthub/doltlite-wasm` (browser; OPFS-backed) and `@dolthub/doltlite` (Node/Bun native) | Both confirmed on the npm registry at 0.11.33. Browser positioning: "a `.wasm` is a full version-controlled SQL database backed by the browser's private filesystem" (https://www.dolthub.com/blog/2026-04-27-why-doltlite/). |
