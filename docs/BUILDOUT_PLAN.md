<!-- HISTORICAL SNAPSHOT — frozen copy of PLAN.md taken at the close of
     the implementation iteration (Step 11, 2026-07-18), kept for the
     record of how the buildout actually went (step cards as executed,
     full step log). Do NOT execute from this file: the living document
     remains PLAN.md at the repo root, which is in maintenance mode. -->
