...
## ABI golden dump (needs a Linux host) — VERIFIED 2026-07-22 (x86-64-linux-host); kept: regeneration procedure + inference caveat
...
step. Executed the same day on an x86-64 Linux build server (JDK
